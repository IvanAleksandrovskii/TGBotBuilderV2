...
class QuizResultAdmin(BaseAdminModel, model=QuizResult):
    ...
    column_details_list = [QuizResult.id, QuizResult.user_id, QuizResult.test_id, QuizResult.category_id, QuizResult.score, QuizResult.result_text, QuizResult.is_active, QuizResult.created_at, QuizResult.updated_at]
