...
critical_thinking = Test(
    name="Оценка аналитики",
    description=(
        "Основано на тесте Старки. Помогает оценить способность кандидата к логическому анализу и принятию взвешенных решений."
    ),
...
critical_thinking_result_1 = Result(
    ...
    max_score=6,
    text=(
        "У вас низкие результаты по тесту критического мышления. Вам сложно справляться с заданиями, "
        "требующими критической оценки информации и логического разбора. Отфильтровывать недостоверную "
        "информацию и собирать объективную, выявлять манипуляции. Вы можете чаще принимать эмоциональные решения. "
        "Вам может быть трудно спорить/дискутировать с людьми. При таком уровне критического мышления очень важно "
        "развивать его – использовать литературу, записываться на образовательные программы. Это может существенно "
        "повысить качество вашей жизни за счет улучшения эмоционального состояния и оптимизируя процесс адаптации."
    ),
)
...
critical_thinking_result_2 = Result(
    ...
    max_score=21,
    text=(
        "Средние результаты теста говорят о том, что вы справляетесь с большинством задач, требующих критической оценки информации. "
        "Вероятно, вы справитесь и с исполнительной, и с руководящей должностями. Вы мыслите логично, способны отфильтровывать "
        "недостоверную информацию и собирать объективную, выявлять манипуляции, принимать взвешенные решения. В интеллектуальных "
        "спорах вы можете аргументированно дискутировать, осознавать свои предвзятости и необъективность других. Однако в сложных, "
        "эмоциональных ситуациях, возможны ошибки в логических решениях, аргументации. В таких случаях вы может чувствовать себя "
        "недостаточно компетентным, проявлять агрессию или приводить недостаточно корректные аргументы. В таких случаях вам "
        "рекомендовано увеличить информированность по необходимым вопросам."
    ),
)
...
critical_thinking_result_3 = Result(
    ...
    max_score=27,
    text=(
        "У вас очень высокие результаты по тесту критического мышления. Вы справитесь практически со всеми задачами, "
        "требующими логического анализа. У вас развита рефлексия. Вы умеете контролировать эмоции, принимаете решения объективно.  "
        "Способны анализировать информацию, проверять ее достоверность. Хорошо распознаете манипуляции со стороны окружающих, рекламы и пр. "
        "Отделяете оценки и допущения от фактов. Понимаете причинно-следственные связи или принимать их отсутствие.  Признаете ограниченность "
        "собственных мыслительных процессов, вырабатываете наиболее оптимальные решения в условиях неопределенности и риска. Умеете ставить "
        "реалистичные цели и находить адекватные пути их достижения. Вы являетесь эффективным профессионалом, в областях требующих принятия "
        "сложных и ответственных решений, а также имеете общее преимущество в жизнедеятельности, адаптации к меняющимся условиям среды."
    ),
)
